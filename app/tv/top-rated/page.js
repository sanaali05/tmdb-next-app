...
const page = () => {
    ...
    useEffect(() => {
        const fetch = async () => {
            const { data } = await axios.get(`/tv/top_rated?api_key=b6330e59d17035fa955abd01c083646b&page=${currentPage}`)
            const topRatedTvData = data.results
    ...
    return (
        <>
            <section className='top-rated-tv'>
                <h1>top-rated  </h1>
